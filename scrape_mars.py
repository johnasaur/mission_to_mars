...
hemisph = "https://astrogeology.usgs.gov/search/results?q=hemisphere+enhanced&k1=target&v1=Mars" 
...
img_one = browser.find_by_text("Sample")["href"]
browser.back()

browser.find_by_css(".thumb")[1].click()
img_two = browser.find_by_text("Sample")["href"]
browser.back()

browser.find_by_css(".thumb")[2].click()
img_three = browser.find_by_text("Sample")["href"]
browser.back()

browser.find_by_css(".thumb")[3].click()
img_four = browser.find_by_text("Sample")["href"]

hemisphere_image_urls = [
    {"title": one, "img_url": img_one},
    {"title": two, "img_url": img_two},
    {"title": three, "img_url": img_three},
    {"title": four, "img_url": img_four}
]
